...
- 세로 사건 타임라인, 펼침 상세, 장면 흐름, 대화 근거와 미디어 슬롯을 갖춘 재사용 웹 리포트 구현
...
기본 웹에는 영상 파일이나 원본 링크를 넣지 않고 미디어 슬롯만 남깁니다. [웹 타임라인 설계](docs/web-timeline.md)에 재사용 구조와 향후 프록시 연결 방식을 기록했습니다.
